...
Task("Pack").Does(() => {
	...
	DotNetCorePack(src + File("Correlation.Core/Correlation.Core.csproj"), coreSettings);	
	DotNetCorePack(src + File("Correlation.AmazonSns/Correlation.AmazonSns.csproj"), coreSettings);
	DotNetCorePack(src + File("Correlation.Serilog/Correlation.Serilog.csproj"), coreSettings);
